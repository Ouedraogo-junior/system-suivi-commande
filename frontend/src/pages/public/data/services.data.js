...
export const SERVICES_CONTENT = {
  fr: {
    ...
    heroSub: "SOGECOP Sarl intervient dans quatre domaines d'expertise complémentaires pour répondre aux besoins des entreprises, institutions et particuliers au Burkina Faso.",
    ...
    domaines: [
      {
        ...
        intro: "Notre atelier d'impression propose une gamme complète de services numériques et Offset, du petit tirage à la grande série, avec des délais maîtrisés et une qualité constante.",
        categories: [
          { name: 'Impression numérique & Offset',      items: ['Cartes de visite, en-têtes de lettre, enveloppes', 'Brochures, catalogues, livrets reliés', 'Affiches format A4 à A0', 'Flyers, dépliants 2 ou 3 volets'] },
          { name: 'Grands formats & signalétique',       items: ['Bâches publicitaires et banderoles', 'Kakémonos et roll-ups', 'Panneaux rigides (dibond, PVC expansé)', 'Habillage vitrine et véhicule'] },
      ...
      },
      {
        ...
        categories: [
          ...
          { name: 'Produits alimentaires & matières premières',    items: ['Denrées alimentaires en vrac et conditionnées', 'Matières premières agricoles', 'Produits pour la restauration collective', 'Approvisionnement pour marchés publics'] },
          { name: 'Fournitures industrielles & institutionnelles', items: ['Mobilier de bureau et scolaire', 'Équipements médicaux et paramédicaux', "Fournitures pour appels d'offres", 'Équipements de protection individuelle (EPI)'] },
        ],
      },
      {
        id: 'amenagement',
  ...
  en: {
    ...
    heroSub: 'SOGECOP Sarl operates in four complementary areas of expertise to meet the needs of businesses, institutions and individuals in Burkina Faso.',
    ...
    domaines: [
      {
        ...
        intro: 'Our print shop offers a full range of digital and offset services, from short runs to large series, with controlled lead times and consistent quality.',
        categories: [
          { name: 'Digital & Offset printing',   items: ['Business cards, letterheads, envelopes', 'Brochures, catalogues, bound booklets', 'Posters from A4 to A0', 'Flyers, 2 or 3-fold leaflets'] },
